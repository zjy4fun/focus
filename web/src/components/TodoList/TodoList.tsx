...
interface TodoListProps {
    ...
    handleStartPress: (event: Event, todo: TodoItem) => void;
                    ...
                    >
                        ...
                        <div className={'btn-container'}>
                            <button onClick={(event) => {
                                handleStartPress(event, todo)
                            }}
                                    className={`start-button ${currentTodo?.id === todo.id ? 'stop' : ''}`}
                            >{currentTodo?.id === todo.id ? 'Stop' : 'Start'}</button>
                            <button onClick={(event) => {
